...
const ListingPage1 = () => {
  ...
  return (
    <div className='w-[100%] h-[100vh] bg-white flex items-center justify-center relative overflow-auto'>
      <form action="" className='max-w-[100vw] w-[90%] h-[550px] flex items-center justify-start flex-col md:items-start gap-[10px] overflow-auto mt:[50px]' onSubmit={(e)=>{ e.preventDefault()
         navigate("/listingpage2") }}>
             <div className='w-[50px] h-[50px] bg-[red] cursor-pointer absolute top-[5%] left-[20px] rounded-[50%] flex items-center justify-center ' onClick={()=>navigate("/")}><FaArrowLeftLong className='w-[30px] h-[30px] text-[white]' /></div>
         ...
         <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]' >
           ...
           <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]' >
            ...
            <input type="number" id="rent" className='w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[18px] px-[20px]' required onChange={(e)=>setRent(e.target.value)} value={rent} placeholder='RS._____/day'/>
           </div>
           ...
           <div className='w-[90%] flex items-start justify-start flex-col gap-[10px]' >
            ...
            <input type="text" id="title" className='w-[90%] h-[40px] border-[2px] border-[#555656] rounded-lg text-[18px] px-[20px]' required onChange={(e)=>setLandmark(e.target.value)} value={landmark}/>
           </div>
